...
/**
 * Created by luiscobian on 4/26/17.
 */

public class MyServicioNotificaciones extends FirebaseMessagingService {

    private static final String LOGTAG = "MyFireStation";
